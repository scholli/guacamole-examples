...
IF ( BOOST_INCLUDE_DIRS AND NOT BOOST_LIBRARY_DIRS )
    ...
    ELSE (NOT _AVANGO_BOOST_FOUND_LIB_DIR)
        ...
        IF (UNIX)
            FILE(GLOB _BOOST_LIBRARIES ${_AVANGO_BOOST_FOUND_LIB_DIR}/libboost_*.so)
	    FOREACH (_CUR_BOOST_LIB ${_BOOST_LIBRARIES})
		get_filename_component(_BOOST_LIB_ABSOLUTE_FILENAME ${_CUR_BOOST_LIB} NAME)
		LIST(APPEND _BOOST_LIBRARIES_ABSOLUTE ${_BOOST_LIB_ABSOLUTE_FILENAME})
	    ENDFOREACH (_CUR_BOOST_LIB ${_AVANGO_BOOST_FOUND_LIB_DIR})
	    SET(BOOST_LIBRARIES ${_BOOST_LIBRARIES_ABSOLUTE})
        ELSEIF (MSVC)
            # use boost auto link
        ENDIF (UNIX)
...
ELSE ( NOT BOOST_INCLUDE_DIRS OR NOT BOOST_LIBRARY_DIRS ) 
    UNSET(BOOST_INCLUDE_SEARCH_DIR CACHE)
    UNSET(BOOST_LIBRARY_SEARCH_DIR CACHE)
    MESSAGE(STATUS "--  found matching boost version ${AVANGO_BOOST_LIB_VERSION}")
