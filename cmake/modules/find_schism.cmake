...
IF ( SCHISM_INCLUDE_DIRS AND ( NOT SCHISM_LIBRARY_DIRS OR NOT SCHISM_LIBRARIES))
    ...
    FOREACH(_LIB_DIR ${_SCHISM_FOUND_LIB_DIR})
		    IF (UNIX)
			    file(GLOB_RECURSE _SCHISM_LIBRARIES_ABSOLUTE ${_LIB_DIR}/libscm*.so)
		    ELSEIF(WIN32)
			    file(GLOB_RECURSE _SCHISM_LIBRARIES_ABSOLUTE ${_LIB_DIR}/scm*.lib)
		    ENDIF(UNIX)
    ENDFOREACH(_LIB_DIR ${_SCHISM_FOUND_INC_DIRS})

    IF (_SCHISM_FOUND_LIB_DIR)
        FOREACH (_SCHISM_LIB_PATH ${_SCHISM_LIBRARIES_ABSOLUTE})
